...
let go1 = receba2 (Number (n1 = prompt(n1Prompt)), Number (n2 = prompt(n2Prompt)))
...
let go2 = maiorIgual2 (Number (i1 = prompt(i1Prompt)), Number (i2 = prompt(i2Prompt)))
...
let bParPrompt = parImpar (Number(b = prompt(bPrompt)))
...
let chamaSalario = salarioDes (Number (salario = prompt (salarioPrompt)))
